...
class HealthrecordsControllerTest < ActionController::TestCase
  ...
  test "should create healthrecord" do
    assert_difference('Healthrecord.count') do
      post :create, healthrecord: { bloodtype: @healthrecord.bloodtype, bmi: @healthrecord.bmi, fats: @healthrecord.fats, height: @healthrecord.height, name: @healthrecord.name, program: @healthrecord.program, weight: @healthrecord.weight }
    end
  ...
  test "should update healthrecord" do
    put :update, id: @healthrecord, healthrecord: { bloodtype: @healthrecord.bloodtype, bmi: @healthrecord.bmi, fats: @healthrecord.fats, height: @healthrecord.height, name: @healthrecord.name, program: @healthrecord.program, weight: @healthrecord.weight }
    assert_redirected_to healthrecord_path(assigns(:healthrecord))
  end
