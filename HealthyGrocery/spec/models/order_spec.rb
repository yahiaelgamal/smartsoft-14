...
Order.get_optimized_orders([o2,o3,o1],99999999999999999999999999999999999999).should == [o2.address,o3.address,o1.address,0]
end
...
Order.get_optimized_orders([o2,o3,o1],5000000).should == [o2.address,o3.address,o1.address,9]
end
