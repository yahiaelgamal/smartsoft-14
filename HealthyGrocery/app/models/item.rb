class ItemsController < ApplicationController
  ...
  #Author: Hazem Amin
  #Function: Added the condition that the amount exists, because in case
  # no amount is entered, the amount will neither be positive nor negative
  # and thus it would throw an error
  def create
